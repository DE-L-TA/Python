...
about_image=tk.PhotoImage(file="images//info.png")
...
forward_image=tk.PhotoImage(file="images//double-arrows.png")
backward_image=tk.PhotoImage(file="images//backward.png")
